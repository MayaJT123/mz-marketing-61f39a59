...
const translations = {
  en: {
    ...
    'services.digital.desc0': 'Comprehensive digital strategy development',
    'services.digital.desc1': 'Multi-channel campaign management',
    'services.digital.desc2': 'Performance tracking and optimization',
    'services.digital.desc3': 'Digital transformation consulting',
    'services.social': 'Social Media Management',
    'services.social.desc': 'Engaging content and community building across all platforms',
    'services.social.desc1': 'Content creation and scheduling',
    'services.social.desc2': 'Community engagement and management',
    'services.social.desc3': 'Content creation and scheduling',
    'services.social.desc4': 'Influencer partnerships',
    'services.social.desc5': 'Social media advertising',
    'services.branding': 'Brand Development',
    'services.branding.desc': 'Creating powerful brand identities that resonate',
    'services.branding.desc1': 'Brand identity design',
    'services.branding.desc2': 'Brand strategy and positioning',
    'services.branding.desc3': 'Visual identity systems',
    'services.branding.desc4': 'Brand guidelines development',
    'services.seo': 'SEO & SEM',
    'services.seo.desc': 'Optimizing your visibility on search engines',
    'services.seo.desc1': 'Keyword research and optimization',
    'services.seo.desc2': 'Technical SEO audits',
    'services.seo.desc3': 'Link building strategies',
    'services.seo.desc4': 'Local SEO optimization',
  ...
  ar: {
    ...
    'services.digital.desc0': 'تطوير استراتيجية رقمية شاملة',
    'services.digital.desc1': 'إدارة الحملات متعددة القنوات',
    'services.digital.desc2': 'تتبع الأداء والتحسين',
    'services.digital.desc3': 'استشارات التحول الرقمي',
    'services.social': 'إدارة وسائل التواصل الاجتماعي',
    'services.social.desc': 'محتوى جذاب وبناء مجتمع عبر جميع المنصات',
    'services.social.desc1': 'إنشاء المحتوى وجدولته',
    'services.social.desc2': 'إدارة المجتمع والتفاعل',
    'services.social.desc3': 'إنشاء المحتوى وجدولته',
    'services.social.desc4': 'شراكات المؤثرين',
    'services.social.desc5': 'الإعلان على وسائل التواصل الاجتماعي',
    'services.branding': 'تطوير العلامة التجارية',
    'services.branding.desc': 'إنشاء هويات علامة تجارية قوية لها صدى',
    'services.branding.desc1': 'تصميم هوية العلامة التجارية',
    'services.branding.desc2': 'استراتيجية العلامة التجارية وتحديد الموقع',
    'services.branding.desc3': 'أنظمة الهوية البصرية',
    'services.branding.desc4': 'تطوير إرشادات العلامة التجارية',
    'services.seo': 'تحسين محركات البحث والتسويق',
    'services.seo.desc': 'تحسين ظهورك على محركات البحث',
    'services.seo.desc1': 'البحث عن الكلمات الرئيسية وتحسينها',
    'services.seo.desc2': 'تدقيق تحسين محركات البحث التقني',
    'services.seo.desc3': 'استراتيجيات بناء الروابط',
    'services.seo.desc4': 'تحسين محركات البحث المحلية',
  ...
  he: {
    ...
    'services.digital.desc0': 'פיתוח אסטרטגיה דיגיטלית מקיפה',
    'services.digital.desc1': 'ניהול קמפיינים רב-ערוציים',
    'services.digital.desc2': 'מעקב וביצועים ואופטימיזציה',
    'services.digital.desc3': 'ייעוץ טרנספורמציה דיגיטלית',
    'services.social': 'ניהול מדיה חברתית',
    'services.social.desc': 'תוכן מרתק ובניית קהילה בכל הפלטפורמות',
    'services.social.desc1': 'יצירת תוכן ותזמון',
    'services.social.desc2': 'מעורבות וניהול קהילה',
    'services.social.desc3': 'יצירת תוכן ותזמון',
    'services.social.desc4': 'שותפויות עם משפיענים',
    'services.social.desc5': 'פרסום במדיה חברתית',
    'services.branding': 'פיתוח מותג',
    'services.branding.desc': 'יצירת זהויות מותג חזקות שמהדהדות',
    'services.branding.desc1': 'עיצוב זהות מותג',
    'services.branding.desc2': 'אסטרטגיה ומיקום מותג',
    'services.branding.desc3': 'מערכות זהות חזותית',
    'services.branding.desc4': 'פיתוח הנחיות מותג',
    'services.seo': 'קידום אתרים ושיווק במנועי חיפוש',
    'services.seo.desc': 'אופטימיזציה של הנראות שלך במנועי חיפוש',
    'services.seo.desc1': 'מחקר ואופטימיזציה של מילות מפתח',
    'services.seo.desc2': 'ביקורות SEO טכני',
    'services.seo.desc3': 'אסטרטגיות בניית קישורים',
    'services.seo.desc4': 'אופטימיזציה של SEO מקומי',
